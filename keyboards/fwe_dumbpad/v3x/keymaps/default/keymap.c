...
#define VIM_LAYER 2
#define TBD_LAYER_3 3
#define TBD_LAYER_4 4
#define TBD_LAYER_5 5
#define TBD_LAYER_6 6
#define TBD_LAYER_7 7

#define LAYER_CYCLE_START 0
#define LAYER_CYCLE_END 7 // ENSURE is the highest numer available on keyboard
...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    */
    [NUMPAD_LAYER] = LAYOUT(
        ...
        KC_MUTE,    KC_CYCLE_LAYERS,  KC_P0,    KC_PPLS,        KC_ENTER
    ),
    /*
    ...
    */
    ...
    [NUMLOCK_LAYER] = LAYOUT(
        ...
        KC_MUTE,    KC_CYCLE_LAYERS,  KC_NO,     KC_NO,     KC_NO
    ),
